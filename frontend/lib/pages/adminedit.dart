...
class _AdminEventEditState extends State<AdminEventEdit> {
  ...
  final String _ip =
      '128.199.8.191'; //// REPLACE WITH YOUR IP / IP OF HOST WHEN IN DEPLOYMENT
  ...
  Future<void> fetchEventDetails() async {
    final url = Uri.parse('http://128.199.8.191:8080/event/byId/${widget.eventID}');
    try {
  ...
  Future<void> editStartDate(int id, String newDate) async {
    final String url =
        'http://128.199.8.191:8080/event/editStartDate/$id'; //// CHNAGE WITH YOUR IP
  ...
  Future<void> editEndDate(int id, String endDate) async {
    final String url =
        'http://128.199.8.191:8080/event/editEndDate/$id'; //// CHNAGE WITH YOUR IP
  ...
  Future<void> editEndTime(int id, String endTime) async {
    final String url =
        'http://128.199.8.191:8080/event/editEndTime/$id'; //// CHNAGE WITH YOUR IP
...
Future<void> editStartTime(int id, String startTime) async {
  final String url =
      'http://128.199.8.191:8080/event/editStartTime/$id'; //// CHNAGE WITH YOUR IP
...
Future<void> editEventDescription(int id, String description) async {
  final String url =
      'http://128.199.8.191:8080/event/editDescription/$id'; //// CHNAGE WITH YOUR IP
...
Future<void> editEventName(int id, String newName) async {
  final String url =
      'http://128.199.8.191:8080/event/editEventName/$id'; //// CHNAGE WITH YOUR IP
...
Future<void> editEventImage(int id, String newImage) async {
  final String url =
      'http://128.199.8.191:8080/event/editImage/$id'; //// CHNAGE WITH YOUR IP
